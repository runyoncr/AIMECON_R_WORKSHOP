...
- [Anthropic API keys can be obtained through Claude Console](https://console.anthropic.com/)
  - [Anthropic API pricing](https://www.claude.com/pricing#api)
- [OpenAI API keys can be obtained through the OpenAI Platform](https://platform.openai.com/api-keys)
  - [OpenAI API pricing](https://openai.com/api/pricing/)
- [Google Gemini API keys can obtained through the Google AI Studio](https://aistudio.google.com/welcome)
...
A very simple function to call the Anthropic Claude Sonnet 4.5 model is here: @sec-call-claude.
Below I've made a stripped-down version of the model function, indicating what information needs to be changed if you want to use another model.
