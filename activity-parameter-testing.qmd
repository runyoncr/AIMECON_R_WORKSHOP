...
```
```{r high temp result, message = FALSE, warning = FALSE}
...
save(edmeasure_low, file = "./data/edmeasure_low.Rdata")

```
```{r low edm result, echo = FALSE}

load("data/edmeasure_low.Rdata")
