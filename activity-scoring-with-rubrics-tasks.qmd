...
### Task: Batch Scoring with Rubrics
...
So we did see some variation, but I also used the default temperature. Let's redo the batch call with `temperature = 0`. 
...
Now we're seeing more consistent scores!
