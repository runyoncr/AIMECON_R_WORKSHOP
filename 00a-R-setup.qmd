...
[Posit](https://posit.co/) makes a wonderful integrated development environment (IDE) called [R Studio Desktop](https://posit.co/download/rstudio-desktop/). This is my preferred IDE for R, although you may choose others if you like. I will be using R Studio throughout the workshop.

I am using R Studio Version 2025.09.1+401, which was installed on October 5, 2025.

## Installing R Tools

[RTools](https://cran.r-project.org/bin/windows/Rtools/) is necessary to install or build R packages that require compilation of C, C++, or Fortran code, as it provides the necessary compiler toolchain and build tools. The packages that are available on [CRAN](https://cran.rstudio.com/) do not require having RTools installed because the packages hosted there are precompiled binary packages.
