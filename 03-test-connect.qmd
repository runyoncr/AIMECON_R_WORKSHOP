...
For the purposes of this workshop I've set up an API key through Anthropic for you all to use ([see here](@sec-workshop-key)).
...
This is especially the case in the simple function above, as we haven't made an effort to tune the [model generation parameters](@sec-gen-params) to achieve a deterministic or replicable result.
