...
They generally look something like this: `sk-1234567890abcdefGHIJKLMNOPQRSTUVWXYZ1234`.
...
If you _must_ use a specific provider or model due to institutional policy or other agreements, I think any of the foundational flagship models from the major providers can now complete most tasks reasonably well, provided that you are using them effectively (the purpose of this workshop!).
