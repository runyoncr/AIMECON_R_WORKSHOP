...
We'll only cover a sampling of these methods in the workshop today.
I want to keep the focus more on their application than extensively testing different prompting strategies.
I encourage you to further explore these techniques based on your specific use case.

## Prompt Engineering Importance

These models are _amazing_ pattern matchers - they can identify other tokens that are close together in the multidimensional embedding space.
And it's important to use words (tokens) that appropriately leverage the model's attention - and also to make sure you're not diffusing the attention by including too many instructions.

Achieving both of these goals is at the heart of the field of prompt engineering. The following are some useful tips to help you achieve these goals.
...
<center>[screenshot of Mad Libs taken from here](https://madlibs.com/wp-content/uploads/2024/06/VacationFun_ML_2009_pg15.pdf)</center>
...
<center>This common formula is Role–Task–Goal.</center>
...
While this also touches on [multi-agentic systems, which we'll briefly discuss later](21-chained-workflows.qmd#sec-chained-workflows), the main point is that there are a _lot_ of other instructions that happen behinds the scenes that are invisible to the user. 
...
I won't go into much detail here because [we'll cover this in more depth later (including an activity)](activity-chained-workflows.qmd#sec-act-chained), but I want to mention it here for completeness while discussing effective prompt engineering strategies.
...
[^2]: I would argue that the process of generating the response isn't really "thinking" in the sense that you and I know the word. 
Anthropic has published [research showing that models don't always say what they're actually thinking](https://www.anthropic.com/research/reasoning-models-dont-say-think) when providing a response that "shows" their reasoning.
