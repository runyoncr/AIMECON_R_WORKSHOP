...
![](images/under-construction-data.png){fig-align="center" width=50%}
...
When you submit a query to a RAG system, it first converts your question into a mathematical representation called an embedding (see @sec-embeddings). 
...
Unsuprisingly (again), Posit has created an app called [`ragnar`](https://ragnar.tidyverse.org/){target="_blank"} that is part of their [`tidyverse`](https://www.tidyverse.org/){target="_blank"} suite of packages.